...
function Card ({ title, data: { lifecycle, status, user = {}, build_num, queued_at, workflows = {}, committer_name } = {} }) {
  ...
  return (
    <Fragment>
      <div className="app-card--header">
        <p className="govuk-body govuk-!-margin-top-2 govuk-!-margin-bottom-0 app-text-right app-text-grey">{status ? moment(queued_at).format('DD/MM/YYYY, HH:mm') : ' '}</p>
